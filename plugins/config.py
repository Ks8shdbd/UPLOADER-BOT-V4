...
class Config(object):
    ...
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001907561496"))
    
    LOGGER = logging

    UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001756081670")
    
    OWNER_ID = int(os.environ.get("OWNER_ID", "5079629749"))
    
    TG_MIN_FILE_SIZE = 2097152000
    
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Ary_payment_bot")
